...
function pickPrimaryOrFallback(primary, fallback) {
    return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["default"].existsSync(primary) ? primary : fallback;
}
function pickFirstExisting(paths) {
    for (const p of paths){
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["default"].existsSync(p)) return p;
    }
    return null;
}
function loadGridFromPaths(fileName, primary, fallback, ensembleName) {
...
function loadBaselinesFromPaths(primary, fallback) {
    const p = pickPrimaryOrFallback(primary, fallback);
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["default"].existsSync(p)) return [];
    const rows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$csv$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseCSV"])(readText(p));
    return rows.map((r)=>({
...
function loadStatsFromPaths(primary, fallback) {
    const p = pickPrimaryOrFallback(primary, fallback);
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["default"].existsSync(p)) return [];
    const rows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$csv$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseCSV"])(readText(p));
    return rows.map((r)=>({
...
function loadStatsFromAnyPaths(paths) {
...
function thresholdsFromGrids(grids) {
    return Array.from(new Set(Object.values(grids).flatMap((pts)=>pts.map((p)=>p.threshold)))).filter((x)=>Number.isFinite(x)).sort((a, b)=>a - b);
}
function loadDataset2a() {
    const gridFiles = [
    ...
    for (const f of gridFiles){
        grids[f] = loadGridFromPaths(f, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "ensemble_v2", f), __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, f));
    }
    return {
        grids,
        baselines: loadBaselinesFromPaths(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "classification_results.csv"), __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "classification_results.csv")),
        stats: loadStatsFromPaths(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "ensemble_v2", "stats_tests_confident_vs_best.csv"), __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "stats_tests_confident_vs_best.csv")),
        thresholds: thresholdsFromGrids(grids)
    };
}
function loadDataset3a() {
    const grids = {
        "LDA_SVM_equal_grid.csv": loadGridFromPaths("LDA_SVM_equal_grid.csv", __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "validation_3a", "ensemble_v2", "models-LDA_SVM__weights-equal__feat-fbcsp__ens-softvote__tune-none__cal-sigmoid", "threshold_metrics.csv"), __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "validation_3a", "LDA_SVM_equal_grid.csv"), "IIIa: LDA+SVM (equal)"),
        "LDA_SVM_baseline_subject_grid.csv": loadGridFromPaths("LDA_SVM_baseline_subject_grid.csv", __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "validation_3a", "ensemble_v2", "models-LDA_SVM__weights-baseline_subject__feat-fbcsp__ens-softvote__tune-none__cal-sigmoid", "threshold_metrics.csv"), __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "validation_3a", "LDA_SVM_baseline_subject_grid.csv"), "IIIa: LDA+SVM (subj-weights)")
    };
    const statsEqual = loadStatsFromAnyPaths([
        __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "validation_3a", "ensemble_v2", "stats_tests_confident_vs_best__equal.csv"),
        __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "validation_3a", "ensemble_v2", "stats_tests_confident_vs_best.csv"),
        __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "validation_3a", "stats_tests_confident_vs_best__equal.csv"),
        __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "validation_3a", "stats_tests_confident_vs_best.csv")
    ]);
    const statsSubj = loadStatsFromAnyPaths([
        __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "validation_3a", "ensemble_v2", "stats_tests_confident_vs_best__baseline_subject.csv"),
        __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "validation_3a", "stats_tests_confident_vs_best__baseline_subject.csv")
    ]);
    return {
        grids,
        baselines: loadBaselinesFromPaths(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(MIND_DIR, "outputs", "validation_3a", "baselines", "classification_results.csv"), __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(PUBLIC_DATA_DIR, "validation_3a", "classification_results.csv")),
        stats: mergeStats([
            statsEqual,
            statsSubj
        ]),
...
;
function Page() {
    const bundle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["loadDashboardBundle"])();
